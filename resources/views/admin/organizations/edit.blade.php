            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Edit Organization</h4>
                        ...
                        <form action="{{ route('admin.organizations.update', $organization) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control @error('type') is-invalid @enderror"
                                        ...
                                        <option value="family" {{ old('type', $organization->type) == 'family' ? 'selected' : '' }}>Family</option>
                                        <option value="group" {{ old('type', $organization->type) == 'group' ? 'selected' : '' }}>Group</option>
                                    </select>
                                    @error('type')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control @error('leader_id') is-invalid @enderror"
                                        ...
                                        @foreach($leaders as $leader)
                                            <option value="{{ $leader->id }}" {{ old('leader_id', $organization->leader_id) == $leader->id ? 'selected' : '' }}>
                                                {{ $leader->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control @error('status_id') is-invalid @enderror"
                                        ...
                                        @foreach($statuses as $status)
                                            <option value="{{ $status->id }}" {{ old('status_id', $organization->status_id) == $status->id ? 'selected' : '' }}>
                                                {{ $status->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <span class="fe fe-save"></span> Update Organization
                                </button>
                            </div>
