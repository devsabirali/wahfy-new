...
<div class="page-header">
    <div class="page-leftheader">
        <h4 class="page-title mb-0">Add Contribution</h4>
    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Add New Contribution</h3>
            </div>
            <div class="card-body">
                @if(hasPermissionOrRole('create-contribution'))
                <form action="{{ route('admin.contributions.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">
                            <i class="fe fe-save mr-2"></i> Save Contribution
                        </button>
                    </div>
                </form>
            </div>
