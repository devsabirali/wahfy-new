                            ...
                            <form action="{{ route('admin.donations.update', $donation) }}" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                                                id="first_name" name="first_name" value="{{ old('first_name', $donation->first_name) }}" required>
                                            @error('first_name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                                id="last_name" name="last_name" value="{{ old('last_name', $donation->last_name) }}" required>
                                            @error('last_name')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="email" name="email" value="{{ old('email', $donation->email) }}" required>
                                    @error('email')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('donation_type') is-invalid @enderror"
                                        ...
                                        <option value="incident" {{ old('donation_type', $donation->donation_type) == 'incident' ? 'selected' : '' }}>Event</option>
                                        <option value="general" {{ old('donation_type', $donation->donation_type) == 'general' ? 'selected' : '' }}>General</option>
                                    </select>
                                    @error('donation_type')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group" id="incident_id_group" style="display: none;">
                                    ...
                                    <select class="form-control @error('incident_id') is-invalid @enderror"
                                        ...
                                        @foreach($incidents as $incident)
                                            <option value="{{ $incident->id }}" {{ old('incident_id', $donation->incident_id) == $incident->id ? 'selected' : '' }}>
                                                {{ $incident->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('payment_method') is-invalid @enderror"
                                        ...
                                        <option value="card" {{ old('payment_method', $donation->payment_method) == 'card' ? 'selected' : '' }}>Card</option>
                                        <option value="offline" {{ old('payment_method', $donation->payment_method) == 'offline' ? 'selected' : '' }}>Offline</option>
                                    </select>
